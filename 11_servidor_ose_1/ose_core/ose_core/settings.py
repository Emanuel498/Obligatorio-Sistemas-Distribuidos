"""
Django settings for ose_core project.
...
SECRET_KEY = 'django-insecure-$72y(-d9gp3)+t&^#o5@=a9$j6i0f94mq9n9+767(u34171lfs'
...
WSGI_APPLICATION = 'ose_core.wsgi.application'
